...
#define ISR_DMA_Done_INTC_VECTOR            ((reg16 *) ISR_DMA_Done__INTC_VECT)
...
#define ISR_DMA_Done_INTC_SET_EN            ((reg8 *) ISR_DMA_Done__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the ISR_DMA_Done interrupt. */
#define ISR_DMA_Done_INTC_CLR_EN            ((reg8 *) ISR_DMA_Done__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the ISR_DMA_Done interrupt state to pending. */
#define ISR_DMA_Done_INTC_SET_PD            ((reg8 *) ISR_DMA_Done__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the ISR_DMA_Done interrupt. */
#define ISR_DMA_Done_INTC_CLR_PD            ((reg8 *) ISR_DMA_Done__INTC_CLR_PD_REG)
