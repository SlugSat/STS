...
*
* \funcusage
*  \snippet USBUART_VBUS_SUT.c usage_USBUART_VBUS_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet USBUART_VBUS_SUT.c usage_USBUART_VBUS_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet USBUART_VBUS_SUT.c usage_USBUART_VBUS_Read  
*******************************************************************************/
...
* preferred USBUART_VBUS_Read() API because the 
* USBUART_VBUS_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet USBUART_VBUS_SUT.c usage_USBUART_VBUS_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: USBUART_VBUS_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use USBUART_VBUS_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - USBUART_VBUS_0_INTR       (First pin in the list)
    *  - USBUART_VBUS_1_INTR       (Second pin in the list)
    *  - ...
    *  - USBUART_VBUS_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet USBUART_VBUS_SUT.c usage_USBUART_VBUS_SetInterruptMode
    *******************************************************************************/
    void USBUART_VBUS_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & USBUART_VBUS_0_INTR) != 0u) 
		{ 
			 USBUART_VBUS_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet USBUART_VBUS_SUT.c usage_USBUART_VBUS_ClearInterrupt
    *******************************************************************************/
