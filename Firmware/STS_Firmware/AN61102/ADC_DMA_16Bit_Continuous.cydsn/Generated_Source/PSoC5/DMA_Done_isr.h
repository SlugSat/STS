...
#define DMA_Done_isr_INTC_VECTOR            ((reg32 *) DMA_Done_isr__INTC_VECT)
...
#define DMA_Done_isr_INTC_SET_EN            ((reg32 *) DMA_Done_isr__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the DMA_Done_isr interrupt. */
#define DMA_Done_isr_INTC_CLR_EN            ((reg32 *) DMA_Done_isr__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the DMA_Done_isr interrupt state to pending. */
#define DMA_Done_isr_INTC_SET_PD            ((reg32 *) DMA_Done_isr__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the DMA_Done_isr interrupt. */
#define DMA_Done_isr_INTC_CLR_PD            ((reg32 *) DMA_Done_isr__INTC_CLR_PD_REG)
